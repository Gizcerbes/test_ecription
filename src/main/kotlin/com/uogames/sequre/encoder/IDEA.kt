...
object IDEA {
    ...
    enum class TYPE(val transformer: String) {
        IDEA("IDEA"),
        IDEA_ECB_NO_PADDING("IDEA/ECB/NoPadding"),
        IDEA_ECB_PKCS5_PADDING("IDEA/ECB/PKCS5Padding"),
        IDEA_CBC_NO_PADDING("IDEA/CBC/NoPadding"),
        IDEA_CBC_PKCS5_PADDING("IDEA/CBC/PKCS5Padding")
    }
    ...
    fun encrypt(
        ...
        val spec = SecretKeySpec(keyBytes, "IDEA")
